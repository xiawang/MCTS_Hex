...
modeules needed:
 - sudo pip install shapely==1.6b2
...
class UnionFind:
    ...
    def union(self):
        ...
        merge_index = {-1}
        for i in xrange(len(self.disjoint_set)-1):
        ...
        if len(merge_index) == 1:
            ...
            for x in xrange(len(self.disjoint_set)-1):
...
class Player:
    ...
    def play(self, board):
        if self.mode == HUMAN:
            input_x = '0'
            while True:
                input_x = raw_input("Players'x cord : ")
                try:
                    temp_x = int(input_x)
            ...
            input_y = '0'
            while True:
                input_y = raw_input("Players'y cord : ")
                try:
                    temp_y = int(input_y)
            ...
            temp_block = raw_input("Type 'ENTER' to start this player ")
            ...
            temp_block = raw_input("Type 'ENTER' to continue the AI process... ")
...
def heuristic1(node, min_max=1):
    ...
    for x in xrange(len(pieces_list)):
    ...
    for x in xrange(len(o_pieces_list)):
...
mode1 = int(raw_input("Player 1's mode : "))
mode2 = int(raw_input("Player 2's mode : "))
print ""
...
while True:
    ...
    if game_board.if_taken(int(input_x), int(input_y)):
        ...
        if if_win == 1:
            ...
            print ""
            time.sleep(0.5)
            temp_block = raw_input("End Game, Exit...")
            time.sleep(2)
            break
        elif if_win == -1:
            game_board.display()
